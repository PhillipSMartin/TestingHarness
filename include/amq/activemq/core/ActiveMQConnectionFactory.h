...
namespace core {
    ...
    public:
         ...
         */
        virtual ActiveMQConnection* createConnection();
         ...
         * @throws CMSException if an error occurs.
         */
        virtual ActiveMQConnection* createConnection(const std::string& username,
                                                  const std::string& password);
    ...
    public:
         ...
         * @throw CMSException.
         */
        static ActiveMQConnection* createConnection(const std::string& uri, const std::string& username,
    ...
    private:
        ...
        ActiveMQConnection* doCreateConnection(const decaf::net::URI& uri, const std::string& username,
                                            const std::string& password, const std::string& clientId);
